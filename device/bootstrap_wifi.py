...
def create_config_json(wlan='wlan0',
                        inet=None,
                        ip='192.168.45.1',
                        netmask='255.255.255.0',
                        ssid='MyAccessPoint',
...
def main():
    parser = argparse.ArgumentParser(description='Creates and stops a wifi hotspot',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('command', choices=['start', 'stop'])
    parser.add_argument('-w', "--wlan", required=False, default=None,
    ...
    parser.add_argument('-s', "--ssid", required=False, default=None, help='name of new hotspot')
    parser.add_argument('-p', "--password", required=False, default='sizaha123',
...
#        return 1
    ...
    if args.wlan is None:
        args.wlan = find_wlan_device()
        logging.info("Selected wireless device - %s" %  args.wlan)

    if args.ssid is None:
        args.ssid = "Sizaha%d" % random.randrange(10000,99999)
